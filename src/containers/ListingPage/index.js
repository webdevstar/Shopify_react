...
export class ListingPage extends Component {
  ...
  componentDidMount() {
    ...
    fetch('http://ec2-35-183-25-66.ca-central-1.compute.amazonaws.com:8080/api/v1/products?lang=en')
      .then(result=>result.json())
      ...
      <li key={ind}>
        ...
        <span className="number">{this.countCategory(category.id)}</span>
        {
          (category.children.length > 0 ?
            <ul className="category-list childrencartegory">
              {
                  ...
                  <div className="page-sidebar-item">
                    ...
                    <div className="sidebar-item__body">
                      <ul className="sidebar-list">
                        <li>
                          <a className={this.isActive('')} onClick={()=>this.setFilter('')}>All</a>
